...
enum Base {
  ...
  u = 4,
  n = 5,
  Base_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  Base_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class Interval final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:genomestore.Interval) */ {
 public:
  Interval();
  virtual ~Interval();
...
class Gene final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:genomestore.Gene) */ {
 public:
  Gene();
  virtual ~Gene();
